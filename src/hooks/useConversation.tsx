...
export function useConversation() {
  ...
  const startNewConversation = useCallback(() => {
    ...
    setMessages([{
      id: 'welcome',
      content: 'שלום! אני העוזר הדיגיטלי של מאגר הידע של פק״ל.\n\nאני יכול לעזור לך למצוא מידע, כלים ומתודולוגיות בנושאי מנהיגות, לכידות ועבודת מטה.\n\nנסה לשאול אותי למשל:\n• איך בונים לכידות בפלוגה?\n• מהם עקרונות המנהיגות הצבאית?\n• איך מנהלים שיחת משוב אפקטיבית?\n\nאיך אני יכול לעזור לך היום?',
      isUser: false,
      timestamp: new Date(),
